...
! ------------------------------------------------------------------------------
    ...
    !!
    !! @par Example
    !! The following example illustrates how to find a line from the 
    ...
    !! @endcode
    !! The above program produces the following output.
    !! @image html two_planes_line_example.png
...
! ------------------------------------------------------------------------------
    ...
    !!
    !! @par Example
    !! The following example finds the shortest line segment between two
    !! other lines.
    !! @code{.f90}
    !! program example
    !!     use iso_fortran_env
    ...
    !! end program
    !! @endcode
    !! @image html line_to_line_distance.png
